...
const TrailerSection = () => {
    ...
    return(
     ...
     <p className='text-gray-300 font-medium text-lg w-[960px] mx-auto'>Trailers</p>
     ...
     <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
        {dummyTrailers.map((trailer)=>(
            ...
            <PlayCircle strokeWidth={1.6} className="absolute top-1/2 left-1/2 w-8 h-8 transform -translate-x-1/2 -translate-y-1/2"/>
            </div>
        ))}
     </div>

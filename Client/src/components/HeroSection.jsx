    ...
    return(
        <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-cover bg-center h-screen' style={{backgroundImage: `url(${BackgroundImage})`}}>
            ...
            <div className='flex items-center gap-4 text-gray-300'>
                ...
                <div className='flex items-center gap-1'> 
                    <ClockIcon className='w-4 h-4.5'/>2h 10m
                </div>
            </div>
            ...
            <button className='flex items-center gap-1 px-6 py-3 text-sm bg-primary-600 hover:bg-primary-dull transition rounded-full font-medium cursor-pointer'>
                Explore Movies

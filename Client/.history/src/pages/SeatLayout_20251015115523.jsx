...
import {ClockIcon} from '../lib/timeFormatimeFormat'
...
useEffect(()=>{
  ...
  return show  ? (
    ...
    <button onClick={()=>navigate('/my-bookings')} className='flex items-center gap-1 mt-20 px-20 px-10 py-3 text-sm
     bg-primary hover:bg-primary-dull transition rounded-full font-medium
     ccursor-pointer active:scale-95'>
    Proceed to Checkout
